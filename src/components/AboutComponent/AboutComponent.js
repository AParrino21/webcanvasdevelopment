    ...
    return (
        <div className="mainAboutDiv">
            <div className="aboutDiv">
                ...
                <img className="me" src='/images/me.png' alt="ceo"></img>
                <div className="gitLinkLinks">
                    <p><a href="https://github.com/goobisanubis21"><img className="git" src='/images/git.png' alt="Git"></img></a></p>
                    <p><a href="https://www.linkedin.com/in/anthony-parrino-887b391b3/"><img className="linked" src='/images/linked.png' alt="LinkedIn"></img></a></p>
                </div>
            </div>
        </div>
    )
